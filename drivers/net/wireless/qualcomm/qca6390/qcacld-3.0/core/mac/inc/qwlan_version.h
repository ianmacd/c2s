...
#define QWLAN_VERSION_EXTRA            "V-HS201105A"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSION_EXTRA            "V-HP201105A"
#else
...
#if defined(QCA_WIFI_QCA6390) //Hastings
#define QWLAN_VERSIONSTR               "5.2.022.3V-HS201105A"
#elif defined(QCA_WIFI_QCA6490) // Hastings Prime
#define QWLAN_VERSIONSTR               "5.2.022.3V-HP201105A"
#else
